...
public class ChessMath {
    ...
    private Piece makeMove(Position source, Position target){ 
        ChessPiece p = (ChessPiece)board.romevePiece(source);
        p.increaseMoveCount();
        Piece capturedPiece = board.romevePiece(target);
        ...
        if(p instanceof King && target.getColumn() == source.getColumn() +2){
            ...
            ChessPiece rook = (ChessPiece)board.romevePiece(sourceT);
        ...
        if(p instanceof Pawn){
           if(source.getColumn() != target.getColumn() && capturedPiece == null){
                ...
                capturedPiece = board.romevePiece(pawnPosition);
                capturedPieces.add(capturedPiece);
                piecesOnTheBoard.remove(capturedPiece);
            } 
        }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ChessPiece p = (ChessPiece)board.romevePiece(target);
        p.decreaseMoveCount();
        ...
        if(p instanceof King && target.getColumn() == source.getColumn() +2){
            ...
            ChessPiece rook = (ChessPiece)board.romevePiece(targetT);
        ...
        if(p instanceof Pawn){
           if(source.getColumn() != target.getColumn() && capturedPiece == enPassantVulnerable){
                ChessPiece pawn = (ChessPiece)board.romevePiece(target);
                Position pawnPosition;
                if(p.getColor() == Color.WHITE){
